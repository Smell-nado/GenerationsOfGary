...
public class MainView : TapSteveElement
{
    ...
    public LimbView childHead;
    public LimbView childBody;
    public LimbView childLimbs;

    public LimbView adultHead;
    public LimbView adultBody;
    public LimbView adultRightArm;
